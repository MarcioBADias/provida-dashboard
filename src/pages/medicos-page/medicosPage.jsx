...
const MedicosPage = () => {
    ...
    const filterMedics = (name, specialty) => {
        const filteredMedics = medicsData.filter(medic => 
    ...
    return (
        <>
            <Menu />
            <h1 style={{textAlign: 'center', marginTop: '1rem'}}>Lista de médicos e especialidades</h1>
            <S.SearchContainer>
                <div>
                    <S.SearchInput type="text" value={searchMed} onChange={handleChangeSearchMed} placeholder='Buscar Profissional...' />
                    <S.SearchBtn className="btn-search">Buscar</S.SearchBtn>
                </div>
                <div>
                    <S.SearchInput type="text" value={searchSpecialty} onChange={handleChangeSearchSpecialty} placeholder='Buscar por especialidade...' />
                    <S.SearchBtn className="btn-search">Buscar</S.SearchBtn>
                </div>
            </S.SearchContainer>
            <S.CardContainer>
